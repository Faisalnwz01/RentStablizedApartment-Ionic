...
.run(function($ionicPlatform, $cordovaGeolocation, $rootScope, $http, $ionicPopup, $ionicLoading) {
    $ionicLoading.show({
        template: 'Loading...',
                    ...
                    currentLocation: function($q, $cordovaGeolocation, $ionicPopup, $ionicLoading, $localStorage) {
                        ...
                        $cordovaGeolocation
                            ...
                            .then(function(position) {
                              ...
                              console.log(JSON.stringify(err), 'err in geting location from cordova')
                                ...
                                if (ifStoreage) {
                                    ...
                                    var alertPopup = $ionicPopup.alert({
                                        title: "Location Setting Turned Off",
                                        template: 'Looks like your location settings are turned off, so we will use your last known location. Please enable location setting to get the nearest restaurants.'
                                    });
